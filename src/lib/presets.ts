...
export const LIGHTROOM_PRESETS: Preset[] = [
  ...
  },
  {
    ...
    adjustments: {
      ...
      hsl: {
        ...
        orange: { hue: 0, sat: 8, lum: 0 },
        yellow: { hue: 2, sat: 12, lum: 0 },
        green: { hue: -4, sat: 24, lum: -8 },
        aqua: { hue: 6, sat: 20, lum: -4 },
        blue: { hue: 2, sat: 26, lum: -10 },
        purple: { hue: 0, sat: 0, lum: 0 },
        magenta: { hue: 0, sat: 0, lum: 0 },
      },
      colorGrading: {
        shadows: { hue: 220, sat: 14 },
        midtones: { hue: 130, sat: 8 },
        highlights: { hue: 48, sat: 12 },
        balance: -10,
      }
    }
  },
  {
    ...
    adjustments: {
      ...
      grain: 8,
      hsl: {
        red: { hue: 2, sat: 18, lum: 4 },
        orange: { hue: 0, sat: 12, lum: 2 },
        yellow: { hue: 0, sat: 14, lum: 0 },
        green: { hue: 4, sat: 16, lum: 0 },
        aqua: { hue: 0, sat: 14, lum: 0 },
        blue: { hue: -4, sat: 20, lum: -6 },
        purple: { hue: 0, sat: 0, lum: 0 },
        magenta: { hue: 0, sat: 0, lum: 0 },
      },
      colorGrading: {
  ...
  {
    id: 'chiaroscuro_master',
    name: 'Кьяроскуро (Барокко)',
    category: 'Арт',
    adjustments: {
      temp: 12,
      tint: -4,
  ...
  {
    id: 'golden_hour_alpine',
    name: 'Золотой альпийский час',
    category: 'Арт',
    adjustments: {
      temp: 22,
      tint: 6,
